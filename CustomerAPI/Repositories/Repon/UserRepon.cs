...
namespace CustomerAPI.Repositories.Repon
{
    public class UserRepon : IUserRepon
    {
        ...
        public UserRepon(CustomerDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<string> Login(LoginModel model)
        {
            try
            {
                //_context.Users.FirstOrDefault(p => p.UserName == model.UserName && p.Password == model.Password);
                ...
                var authClaims = new List<Claim>
            {
                ...
                var token = new JwtSecurityToken(
                    issuer: "https://localhost:7055",//người phát hành
                    audience: "FselCustomer", //là một chuỗi đại diện cho người nhận dự kiến của JWT
